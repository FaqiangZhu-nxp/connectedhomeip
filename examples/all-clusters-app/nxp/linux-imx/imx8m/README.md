# Building and Running CHIP Linux All Clusters Example for i.MX 8M Mini EVK

This document describes how to build the
[CHIP Linux All Clusters Example](../../../linux) with the NXP embedded Linux
Yocto SDK and then run the output executable file on the NXP i.MX 8M Mini EVK
...
-   [Building and Running CHIP Linux All Clusters Example for i.MX 8M Mini EVK](#building-and-running-chip-linux-all-clusters-example-for-imx-8m-mini-evk)
    -   [Building](#building)
...
Before building the CHIP Linux All Clusters Example, the Yocto source code
released by NXP needs to be downloaded, then the Yocto SDK and the EVK Linux
SD card image need to be generated.
...
-   Build the example application:
    ...
    The executable file named chip-all-clusters-app is built under out/aarch64,
   	it can be executed on the i.MX 8M Mini EVK running the Yocto image
	previously generated as described in the sections below.
...
-   Prerequisites
    ...
    -   Copy the executable file chip-all-clusters-app to the i.MX 8M Mini EVK,
...
-   Running
    ...
    -   Run the Linux All Clusters Example App

              $ /home/root/chip-all-clusters-app --ble-device 0     # The bluetooth device used is hci0
